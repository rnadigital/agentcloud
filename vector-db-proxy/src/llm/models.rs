...
impl From<String> for FastEmbedModels {
    fn from(value: String) -> Self {
        match value.as_str() {
            "BAAI/bge-small-en" => FastEmbedModels::BAAI_BGE_SMALL_EN,
            "BAAI/bge-small-en-v1.5" => FastEmbedModels::BAAI_BGE_SMALL_EN_V1_5,
            "BAAI/bge-base-en" => FastEmbedModels::BAAI_BGE_BASE_EN,
            "BAAI/bge-base-en-v1.5" => FastEmbedModels::BAAI_BGE_BASE_EN_V1_5,
            "BAAI/fast-bge-small-zh-v1.5" => FastEmbedModels::BAAI_FAST_BGE_SMALL_ZH_V1_5,
