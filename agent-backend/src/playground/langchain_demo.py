...
if __name__ == '__main__':
    ...
    def get_file_path_of_example():
        ...
        file_path = os.path.join(current_dir, "playground", "test_files", "radius.txt")

        file_path = 'C:\\Github\\rnadigital\\agentcloud\\agent-backend\\src\\playground\\test_files\\radius.txt'
