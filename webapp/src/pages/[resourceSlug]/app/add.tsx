					...
					<div>
						...
						<div className='md:flex gap-8 w-full mt-10'>
							<div className='flex-1 border border-gray-200 p-4 rounded-md group'>
								...
								/>
								<div className='flex flex-col md:flex-row border-t border-gray-200 pt-4 w-full'>
									<div className='flex'>
										<img
									...
									<button
										className='w-full md:w-24 h-9 disabled:bg-primary-200 group-hover:bg-primary-500 group-hover:text-white rounded-lg flex justify-center items-center text-sm mt-4 md:mt-auto max-w-sm border border-gray-200 ml-auto'
