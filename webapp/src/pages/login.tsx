			...
			<div className='flex flex-col md:flex-row md:flex-1 bg-white'>
				<LeftFrame showAnimation>
					<div className='flex justify-center h-full flex-col'>
						<div className='hidden md:block text-5xl leading-normal font-bold'>
				...
				<div className='flex justify-center items-center w-full text-gray-500 px-4 pt-4 md:pt-0'>
					<div className='w-full max-w-md'>
						...
						<form className='space-y-2' onSubmit={handleSubmit(login)}>
							...
							{noverify && (
								<InfoAlert
									message={`Email verification skipped because you are missing AMAZON_ACCESS_ID and/or AMAZON_SECRET_ACCESS_KEY in your current secret manager: "${process.env.NEXT_PUBLIC_SECRET_PROVIDER || 'local'}"`}
								/>
							)}
