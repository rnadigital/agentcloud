...
export function getDatasourceVectors(body, dispatch, errorCallback, router) {
	return ApiCall(`/${body.resourceSlug}/datasource/${body.datasourceId}/vectors.json`, 'GET', null, dispatch, errorCallback, router);
}
