...
export async function addAppApi(req, res, next) {
	...
	let validationError = chainValidations(req.body, [
		...
		{ field: 'tasks', validation: { hasLength: 24, asArray: true, ofType: 'string', customError: 'Invalid Tasks' }, validateIf: { field: 'tasks', condition: () => !isChatApp }},
		{ field: 'agents', validation: { hasLength: 24, asArray: true, ofType: 'string', customError: 'Invalid Agents' }, validateIf: { field: 'agents', condition: () => !isChatApp }},
