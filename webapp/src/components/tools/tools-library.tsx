        ...
        <Fragment>
            ...
            <TabsContent value='tool-library'>
                {displayScreen === 'create' ? (
                    ...
                    <Custom fetchTools={fetchTools} setDisplayScreen={setDisplayScreen} setActiveTab={setActiveTab} />
                ) : (
                            ...
                            <div
                                ...
                                <div className='flex flex-col justify-around lg:justify-between w-full'>
                                    ...
                                    <div className='w-full flex justify-between items-center text-xs'>
                                        <p key={index} className='py-1 px-2 rounded-full w-fit font-weight-bolder bg-gray-100 text-gray-500'>
                                            BuiltIn
                                        </p>
                                        {!tool.linkedToolId && (
                                            <Button variant="outline" className="text-xs flex items-center gap-1 align-middle">
                                                <FaPlus className='inline-block font-extralight scale-75 text-gray-400 z-0'/> Install
                                            </Button>
                                        )}
                                    </div>
                                </div>
