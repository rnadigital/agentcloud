                                    ...
                                    <td className="px-6 py-5 whitespace-nowrap text-right text-sm font-medium flex justify-end space-x-1 items-center">
                                        {userPermissions.get(
                                            ...
                                            !isMe && (
                                                ...
                                                >
                                                    <PencilIcon className="h-4 w-4 text-gray-400 group-hover:text-gray-600 dark:text-gray-300 transition-all duration-100 ease" aria-hidden="true" />
                                                </a>
                                            )}
                                        {userPermissions.get(
                                            ...
                                            !isMe && (
                                                ...
                                                >
                                                    {deleting[member._id] ? (
                                                        ...
                                                        <TrashIcon className="h-4 w-4 text-gray-400 group-hover:text-gray-600 dark:text-gray-300 transition-all duration-100 ease" aria-hidden="true" />
                                                    )}
                                                </button>
                                            )}
                                    </td>
