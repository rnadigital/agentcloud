...
// import SortableItem, { FormFieldConfig } from './SortableItem';
...
// 				{items.map(({ id, config }) => (
// 					<SortableItem key={id} id={id} config={config} />
// 				))}
// 			</SortableContext>
// 			<DragOverlay>
// 				{activeId ? (
// 					<SortableItem id={activeId} config={items.find(item => item.id === activeId)?.config} />
// 				) : null}
// 			</DragOverlay>
// 		</DndContext>
// 	);
