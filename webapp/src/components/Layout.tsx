...
const agentNavigation: any[] = [
	...
	{ name: 'Crews', href: '/crews', icon: <UserGroupIcon className='h-6 w-6 shrink-0' aria-hidden='true' />, indent: 4 },
	...
	{ name: 'Tasks', href: '/tasks', icon: <PencilSquareIcon className='h-6 w-6 shrink-0' aria-hidden='true' />, indent: 4 },
	{ name: 'Tools', href: '/tools', icon: <WrenchScrewdriverIcon className='h-6 w-6 shrink-0' aria-hidden='true' />, indent: 4 },
