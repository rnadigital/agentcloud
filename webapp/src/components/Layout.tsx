		...
		<>
			...
			<footer className={`${showNavs ? 'lg:pl-80' : ''} mt-auto text-gray-500 text-sm bg-gray-50 px-8 sm:flex items-center`}>
				...
				<div className='flex gap-x-2 ml-auto'>
					<a href='https://discord.com/invite/ZNSSttKqqq' target='_blank' rel='noopener noreferrer' className=''>
						<svg width='32' height='24' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
