...
import { CalendarDaysIcon, ClockIcon, Cog6ToothIcon,CubeTransparentIcon,TableCellsIcon } from '@heroicons/react/20/solid';
			...
			<div className='hidden sm:block'>
				<div className='border-b border-gray-200'>
					<nav className='-mb-px flex space-x-8' aria-label='Tabs'>
						{tabs
							.filter(t => !t.excludeSourceTypes || !t.excludeSourceTypes.includes(datasource?.sourceType))
							.map(tab => {
								const ti = tab.i;
								return <a
									href={tab.href}
