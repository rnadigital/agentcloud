...
export default function DatasourceScheduleForm({ scheduleType, setScheduleType, timeUnit, setTimeUnit, units, setUnits, cronExpression, setCronExpression, cronTimezone, setCronTimezone }) {
	return <>
		<label htmlFor='scheduleType' className='block text-sm font-medium leading-6 text-gray-900 dark:text-slate-400 mt-2'>
